...
@onready var timer: Timer = $ConversationUI/Trading/Timer
@export var hover_cursor: Texture2D

var npc_id: String = "npc2"
var current_item_data: Dictionary = {}
var current_price_keys: Array = []   # keep generic
var current_price_index: int = 0

func _ready() -> void:
	GameState.load_npc_stock(npc_id, "res://Data/npc2.json")
	_populate_items()
